module BankLinkLt::FormHelper
  def payment_form(options = {:request_params_hash => request_params_hash, :payment_url => payment_url, :submit_name => submit_name, :form_id => form_id, :form_class => form_class})
